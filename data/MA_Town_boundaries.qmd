...
<qgis version="3.40.6-Bratislava">
  <identifier>SCHOOLDISTRICTS_RglTownLabels</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>Towns from Survey Points (Multi-part Polygons with generalized coastline)</title>
...
This datalayer was created for the purposes of providing an up-to-date polygon version of the town boundaries for the 351 communites of the Commonwealth of Massachusetts. The legislative intent for some boundaries could not be mapped. Boundaries where that is true are identified in the attribute information. The coastline on this layer has been generalized for small-scale cartography and faster display in web map services.
...
This datalayer was created for the purposes of providing an up-to-date polygon version of the town boundaries for the 351 communites of the Commonwealth of Massachusetts. The legislative intent for some boundaries could not be mapped. Boundaries where that is true are identified in the attribute information.</abstract>
  ...
  <extent>
    <spatial minx="-73.53331799999999419" miny="41.23116999999999877" minz="0" dimensions="2" crs="EPSG:26986" maxx="-69.89891799999999478" maxy="42.8883119999999991" maxz="0"/>
    <temporal>
      <period>
